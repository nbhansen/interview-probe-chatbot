/**
 * Technology-Induced Stress Topic Module
 *
 * This module contains all topic-specific content for researching
 * technology-induced stress (technostress). Originally used in the
 * CHI 2025 research study.
 */
...
export const initialMessages = {
  exploration: `Hello, I would like to discuss the impact of technology on stress. Have you experienced technology having a stressing effect on your life?`,

  requirements: `Welcome back. Let's discuss some possible ways to change technology to better fit your needs. How do you believe technology could be improved to decrease its stressing effects on your life?`,

  evaluation: `After watching the video, what are your initial thoughts on the "do not disturb"-function that you just saw?`,
};

// Topic metadata
export const topicMetadata = {
  id: 'technostress',
  name: 'Technology-Induced Stress',
  description: 'Research into stress caused by technology use',
  researchPaper: 'CHI 2025: Chatbots for Data Collection in Surveys',
};
